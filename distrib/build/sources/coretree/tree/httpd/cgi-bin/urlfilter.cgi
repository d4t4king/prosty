...
&openpage($tr{'urlfilter configuration'}, 1, '', 'services');
...
<div>
  ...
  <p style='margin:1em 0 1.5em .5em; text-align:left; display:inline-block'>
    <input type='checkbox' name='ENABLE_CUSTOM_BLACKLIST'
		       $checked{'ENABLE_CUSTOM_BLACKLIST'}{'on'} />
	</p>
</div>
...
<tr>
	<td colspan='2' style='text-align:center'>
	  <textarea name='CUSTOM_BLACK_DOMAINS' cols='36' rows='6' wrap='off'
...
print <<END
	...
	<td colspan='2' style='text-align:center'>
	  <textarea name='CUSTOM_BLACK_URLS' cols='36' rows='6' wrap='off'
...
<div>
  ...
  <p style='margin:1em 0 1.5em .5em; text-align:left; display:inline-block'>
    <input type='checkbox' name='ENABLE_CUSTOM_WHITELIST'
		       $checked{'ENABLE_CUSTOM_WHITELIST'}{'on'} />
	</p>
</div>
<table style='margin:0 1em 0 2em'>
<tr>
	<td colspan='2' style='text-align:center'>
	  <p style='margin:0 2em 0 0'>
		  $tr{'urlfilter allowed domains'}&nbsp;<img src='/ui/img/blob.gif' alt='*' />
	  </p>
  </td>
	<td colspan='2' style="text-align:center">
	  <p style='margin:0 0 0 2em'>
    	$tr{'urlfilter allowed urls'}&nbsp;<img src='/ui/img/blob.gif' alt='*' />
	  </p>
  </td>
</tr>
<tr>
	<td colspan='2' style='text-align:center'>
	  <textarea name='CUSTOM_WHITE_DOMAINS' cols='36' rows='6' wrap='off'
              style='margin:0 2em 0 0'>
END
;
...
print <<END
	...
	<td colspan='2' style='text-align:center'>
	  <textarea name='CUSTOM_WHITE_URLS' cols='36' rows='6' wrap='off'
              style='margin:0 0 0 2em'>
END
;
...
<div>
  ...
  <p style='margin:1em 0 1.5em .5em; text-align:left; display:inline-block'>
    <input type='checkbox' name='ENABLE_CUSTOM_EXPRESSIONS'
		       $checked{'ENABLE_CUSTOM_EXPRESSIONS'}{'on'} />
	</p>
</div>
<table width='100%'>
...
<tr>
	<td colspan='4' style='text-align:center'>
	  <textarea name='CUSTOM_EXPRESSIONS' cols='80' rows='6' wrap='off'
...
<tr>
        <td width='25%' class='base'>$tr{'urlfilter block executables'}:</td>
...
print <<END
	...
	<td colspan='2' style='text-align:center'>
	  <textarea name='BANNED_CLIENTS' cols='36' rows='6' wrap='off'
              style='margin:0 0 0 2em'>
END
;
...
<table width='100%' style='margin-top:1em'>
<tr>
	<td width='25%' class='base'>$tr{'urlfilter show category'}:</td>
	<td width='3%'><input type='checkbox' name='SHOW_CATEGORY' $checked{'SHOW_CATEGORY'}{'on'} /></td>
	<td width='20%' class='base'><img src='/ui/img/blob.gif' alt='*' />&nbsp;$tr{'urlfilter redirectpage'}:</td>
